...
const AddBannerComponent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsUploading(true); // Loading sync karo
      const body = {
        bannerName: formData.name.trim(), // Backend field name
      ...
      alert("Banner created successfully!"); // Or redirect to list
      // Reset form
  ...
  const handleCancel = () => {
    console.log("Add banner cancelled");
    setFormData({ name: "", image: "", active: true }); 
    router.push("/admin/banners")
  };
